  ...
  return (
    <div className="relative min-h-[80vh] w-full overflow-hidden bg-gradient-to-b from-blue-50 via-blue-100 to-white">
      ...
      <div className="relative mx-auto h-full max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="relative h-full pt-24 sm:pt-14">
          <Reveal type="top" className="text-center">
            <div className="mb-4">
            ...
            <p className="mx-auto mt-6 max-w-4xl text-lg leading-8 text-blue-700">
              Spend more time applying and less time writing. Just answer some
              questions about your work experience, skills, etc. and let ResumAI
              create your entire resume, formatting and all.
            </p>
            <div className="xs:flex-row mt-10 flex items-center justify-center gap-4">
              <Button
                size="lg"
