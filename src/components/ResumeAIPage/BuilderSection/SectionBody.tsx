    ...
    >
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-8 py-4 sm:py-24 lg:py-0 lg:grid-cols-3 lg:px-8">
        ...
        <motion.div
          ...
          className={cn(
            "order-2 flex flex-col items-start justify-center text-center sm:order-1 lg:items-start lg:text-left lg:col-span-1",
        ...
        >
          ...
          {data?.points?.map((item: SectionPointsProps) => (
            <motion.div key={item.id} className="flex gap-2 mb-8 items-start justify-center">
        ...
        {/* Right image */}
        <Reveal type="left" className="col-span-2">
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ delay: 0.4, duration: 1 }}
            className="relative order-1 flex items-center justify-center sm:order-2 lg:justify-end h-full w-full"
          >
