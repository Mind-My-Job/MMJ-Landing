      ...
      <AnimatePresence>
        ...
        >
          {/* <motion.div
            ...
            custom={{ x: -10, y: -10 }}
            className="pointer-events-none absolute left-[5.5rem] top-[3px] z-10"
          >
            <SettingsFilled className="scale-110 text-[#005FF2] dark:text-[#006EFE]" />
          </motion.div>
          <motion.div
            initial="hidden"
            animate={isHovered ? "visible" : "hidden"}
            variants={iconVariants}
            custom={{ x: 10, y: 10 }}
            className="pointer-events-none absolute bottom-[4px] left-[9.7rem] z-10"
          >
            <SettingsFilled className="scale-110 text-[#005FF2] dark:text-[#006EFE]" />
          </motion.div> */}
          <div className="upgradeBanner relative flex h-full items-center justify-center gap-1 rounded-[6px] bg-blue-100 p-3 pl-2.5 pr-1 text-base dark:border-[#003674] dark:bg-[#06193A]">
            <span className="text-[#005FF2] dark:text-[#44A7FF]">
              {startText}
            </span>
            <button
              className="focus-visible:shadow-focus-ring rounded-xs my-[-1px] cursor-pointer border-none bg-transparent px-0 py-1 font-sans font-medium text-[#002359] underline decoration-[#94CCFF] underline-offset-[5px] outline-none hover:text-[#005FF2] hover:decoration-[#008FFF] focus-visible:!shadow-[#008FFF] dark:text-[#EAF5FF] dark:decoration-[#003674] dark:hover:text-[#44A7FF] dark:hover:decoration-[#00408A]"
